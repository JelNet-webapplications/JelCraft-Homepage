...
<html lang="en">
    ...
    <body>
        ...
        <p>
            Please read this cookie policy (“cookie policy”, "policy") carefully before using the JelNet website
            (“website”, "service") operated by JelCraft ("us", 'we", "our").
        </p>
        ...
        <h2>Contacting us</h2>
        <p>If you have any questions about this policy or our use of cookies, <b>please do not contact us</b>.</p>
    </body>
</html>
